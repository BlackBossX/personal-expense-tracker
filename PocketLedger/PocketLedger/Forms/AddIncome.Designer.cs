namespace project
{
    partial class AddIncome
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3 = new Label();
            label4 = new Label();
            PocketLedger.SuspendLayout();
            panel1.SuspendLayout();
            SuspendLayout();
            // 
            // PocketLedger
            // 
            PocketLedger.BackColor = Color.MidnightBlue;
            PocketLedger.BorderStyle = BorderStyle.Fixed3D;
            PocketLedger.Controls.Add(button11);
            PocketLedger.Controls.Add(button10);
            PocketLedger.Controls.Add(button9);
            PocketLedger.Controls.Add(button8);
            PocketLedger.Controls.Add(button7);
            PocketLedger.Controls.Add(button6);
            PocketLedger.Controls.Add(label1);
            PocketLedger.Controls.Add(label2);
            PocketLedger.Location = new Point(0, 2);
            PocketLedger.Name = "PocketLedger";
            PocketLedger.Size = new Size(220, 705);
            PocketLedger.TabIndex = 1;
            // 
            // button11
            // 
            ...
            panel1.Location = new Point(359, 145);
            panel1.Name = "panel1";
            panel1.Size = new Size(663, 377);
            panel1.TabIndex = 2;
            ...
            comboBox2.Items.AddRange(new object[] { "USD", "LKR" });
            comboBox2.Location = new Point(389, 174);
            comboBox2.Name = "comboBox2";
            comboBox2.Size = new Size(167, 33);
            ...
            dateTimePicker1.Size = new Size(175, 31);
            ...
            comboBox1.Items.AddRange(new object[] { "USD", "LKR" });
            comboBox1.Location = new Point(389, 87);
            ...
            button1.Location = new Point(239, 258);
            ...
            label3.Location = new Point(265, 47);
            label3.Name = "label3";
            label3.Size = new Size(202, 38);
            label3.TabIndex = 3;
            label3.Text = "Add Income";
            // 
            // label4
            // 
            ...
            label4.Location = new Point(265, 85);
            label4.Name = "label4";
            label4.Size = new Size(461, 28);
            label4.TabIndex = 4;
            label4.Text = "Record your earnings and watch your balance grow";
            // 
            // AddIncome
            // 
